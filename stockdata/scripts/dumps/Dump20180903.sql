...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`chenyl`@`%`*/ /*!50003 TRIGGER `block_AFTER_INSERT` AFTER INSERT ON `block` FOR EACH ROW
BEGIN
...
) ENGINE=InnoDB AUTO_INCREMENT=939915 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=67561 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-09-03 18:18:35
